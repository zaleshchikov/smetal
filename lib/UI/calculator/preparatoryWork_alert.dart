                ...
                content: Container(
                  ...
                  child: ReactiveFormBuilder(
                      ...
                      builder: (context, alert_form, child) {
                        alertForm.control('leftWall').value = client.leftWall != 0;
                        alertForm.control('rightWall').value = client.rightWall != 0;
                        alertForm.control('ceiling').value = client.ceiling != 0;
                        alertForm.control('floor').value = client.floor != 0;
                        alertForm.control('railings').value = client.railings != 0;
                        alertForm.control('leftWall').value = client.leftWall != 0;
                        alertForm.control('column').value = client.column != 0;
                        alertForm.control('front').value = client.front != 0;
